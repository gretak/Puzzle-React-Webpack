...
const routes = (
 <Router history={hashHistory}>
  ...
  <Route path="/levelone" components={()=>(<div><Navigation /><Header imgNumber={20} puzzleLevel="puzzleLevelOne" puzzleClass="puzzle_img20"/><Counter defaultProperty="Likes"/></div>)}/>
  <Route path="/leveltwo" components={()=>(<div><Navigation /><Header imgNumber={30} puzzleLevel="puzzleLevelTwo" puzzleClass="puzzle_img30"/><Counter defaultProperty="Likes"/></div>)}/>
  <Route path="/levelthree" components={()=>(<div><Navigation /><Header imgNumber={48} puzzleLevel="puzzleLevelThree" puzzleClass="puzzle_img48"/><Counter defaultProperty="Likes"/></div>)}/>
 </Router>
);
